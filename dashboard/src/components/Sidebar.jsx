...
const Sidebar = () => {
  ...
  const navItems = [
    { to: '/stats', icon: <LineChartOutlined className="text-2xl" />, text: 'Stats' },
    { to: '/alltask', icon: <TrophyOutlined className="text-2xl" />, text: 'All Tasks' },
    { to: '/completeTask', icon: <MdOutlineTaskAlt className="text-2xl" />, text: 'Completed Tasks' },
    { to: '/pendingTask', icon: <MdPendingActions className="text-2xl" />, text: 'Pending Tasks' },
    { to: '/inProgressTask', icon: <GrInProgress className="text-2xl" />, text: 'In Progress Tasks' },
    { to: '/deployedTask', icon: <MdCloudDone className="text-2xl" />, text: 'Deployed Tasks' },
    { to: '/deferredTask', icon: <MdOutlineAccessTimeFilled className="text-2xl" />, text: 'Deferred Tasks' },
    { to: '/addTask', icon: <MdAddTask className="text-2xl" />, text: 'Add New Tasks' },
    { to: '/tasksAI', icon: <ThunderboltOutlined className="text-2xl" />, text: 'Tasks AI Helper' },
    { to: '/pomodro', icon: <FieldTimeOutlined className="text-2xl" />, text: 'Pomodro' },
  ];
